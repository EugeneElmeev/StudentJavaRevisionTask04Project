...
public class Task01 {
    ...
    public static int task01(int hour1, int minute1, int second1, int hour2, int minute2, int second2) {
        int result = Math.abs((hour1 * 3600 + minute1 * 60 + second1) - (hour2 * 3600 + minute2 * 60 + second2));
        if (24 > hour1 && hour1 >= 0 && 24 > hour2 && hour2 >= 0 && 60 > minute1 && minute1 >= 0 && 60 > minute2 && minute2 >= 0
                && 60 > second1 && second1 >= 0 && 60 > second2 && second2 >= 0) {
            return result;
        }
        return -1;
    }
