...
public class Task06 {
    public static String task06(int a1, int b1, int c1, int a2, int b2, int c2) {
        ...
        if ((a1 == a2 && b1 == b2 && c1 == c2) || (a1 == a2 && b1 == c2 && c1 == b2) || (a1 == b2 && b1 == a2 && c1 == c2)
                || (a1 == b2 && b1 == c2 && c1 == a2) || (a1 == c2 && b1 == b2 && c1 == a2) || (a1 == c2 && b1 == a2 && c1 == b2)) {
            return "Boxes are equal.";
        } else if ((a1 >= a2 && b1 >= b2 && c1 >= c2) || (a1 >= a2 && b1 >= c2 && c1 >= b2) || (a1 >= b2 && b1 >= a2 && c1 >= c2)
                || (a1 >= b2 && b1 >= c2 && c1 >= a2) || (a1 >= c2 && b1 >= b2 && c1 >= a2) || (a1 >= c2 && b1 >= a2 && c1 >= b2)) {
